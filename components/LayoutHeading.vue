          ...
          <div class="row">
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
              ...
              <div class="main-menu navbar-collapse collapse">
                <nav>
                  <ul>
                    <li><nuxt-link exact to="/" class="has dropdown-toggle">Home <i class="fa fa-chevron-down"
                                                                                 aria-hidden="true"></i></nuxt-link>
                      <ul class="sub-menu">
                        <li><nuxt-link exact to="/">Home 1</nuxt-link></li>
                    ...
                    <li><a href="#" class="has">Pages <i class="fa fa-chevron-down" aria-hidden="true"></i></a>
                      <ul class="sub-menu">
                        ...
                        <li><a href="#">Category <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                          <ul>
                            <li><a href="/category-style1">Category Style 1</a></li>
